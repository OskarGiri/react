            ...
            <div className=" container mx-auto px-4 py-5 lg:py-8">
                ...
                <div className="top ">
                    ...
                    <div className=" bg-pink-50 py-5 rounded-xl border border-pink-100">
                        ...
                        {/* text  */}
                        <div className="">
                            <h1 className=" text-center text-lg"><span className=" font-bold">Name :</span>  Nayan Upadhyay</h1>
                                ...
                                <div className="p-8">
                                    <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-1">
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <div className="text-sm font-medium text-gray-900">₹15,499</div>
                                        </div>

                                        <div className="mb-4">
                                            <div className="text-sm font-semibold">Rent Status</div>
